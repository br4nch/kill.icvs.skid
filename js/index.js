...
function addPopupListeners(popupId, closeBtnClass, okBtnClass) {
  document
    .querySelector(`button.${closeBtnClass}`)
    .addEventListener("click", function () {
      hidePopup(popupId);
    });
  document
    .querySelector(`button.${okBtnClass}`)
    .addEventListener("click", function () {
      hidePopup(popupId);
    });
}
...
document.addEventListener("DOMContentLoaded", function () {
  addPopupListeners("PopUpTokyo", "ToykoClose", "TokyoOK");
  addPopupListeners("PopUpIcv", "IcvClose", "IcvOK");
  addPopupListeners("PopUpPolat", "PolatClose", "PolatOK");
